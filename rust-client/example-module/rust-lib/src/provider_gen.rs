// Generated by logos-lidl-gen --provider from the `blockchain_client_example` LIDL contract — do not edit.
//
// The common module-impl C ABI (logos_module_impl.h) around a Rust impl:
// implement `BlockchainClientExampleModule` on your type and define the install hook:
//
//     #[no_mangle]
...
pub trait BlockchainClientExampleModule: 'static {
...
pub fn install<T: BlockchainClientExampleModule + Default>() {
    fn ensure_impl<T: BlockchainClientExampleModule + Default>(require_emit: bool) {
